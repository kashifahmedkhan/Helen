...
add_action( 'widgets_init', 'thememaple_about_load_widget' );

function thememaple_about_load_widget() {
	register_widget( 'thememaple_about_widget' );
}

class thememaple_about_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function thememaple_about_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'thememaple_about_widget', 'description' => __('A widget that displays an About widget', 'thememaple_about_widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'thememaple_about_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'thememaple_about_widget', __('ThemeMaple: About Me', 'thememaple_about_widget'), $widget_ops, $control_ops );
	}
